...
export default function MorePage() {
  ...
  const items = [
    ...
    ['/catch', '🎯', 'Catch calculator', 'Exact odds per ball, status and HP; Safari Zone'],
    ['/farming', '📈', 'Levels & farming', 'Level curve vs every boss, best EXP and money spots'],
    ['/held-items', '🪙', 'Held-item farming', 'Lucky Egg, Leftovers, Metal Coat: who holds what and where'],
    ['/mechanics', '📐', 'Mechanics', 'Gen 3 rules: physical/special, status, abilities, natures, quirks'],
    ['/bag', '📦', 'Bag & PC', 'Your boxes with IVs, EVs and hidden power; bag and PC items from the save'],
    ['/postgame', '🏝', 'Post-game', 'Sevii sidequests, Vs. Seeker rematch tiers, Trainer Tower, Game Corner, tutors'],
    ['/breeding', '🥚', 'Breeding', 'Four Island Day Care: parents, egg moves, and who in your PC fits'],
    ['/moves', '📜', 'Moves', 'All 354 moves with Gen 3 categories'],
    ['/items', '🎒', 'Items', 'Descriptions and where to find them'],
    ['/tms', '💿', 'TM planner', 'Single-use TMs: what you carry, what is buyable, who should get it'],
